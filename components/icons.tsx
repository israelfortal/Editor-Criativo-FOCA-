...
export const SpinnerIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.667 0l3.181-3.183m-11.667-11.667l3.181 3.183m0 0l-3.181 3.183m0 0l3.181-3.183m0 0h-4.992m-4.993 0v4.992"
    />
  </svg>
);
...
export const CutIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M7.875 14.25l1.313-1.313 1.313 1.313m-2.626 0l1.313-1.313 1.313 1.313M10.5 9.75l.938-.938 3.812 3.812-.938.938-3.812-3.812zm0 0L9.563 8.813 5.75 12.625l.938.938 3.812-3.813z"
    />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M10.5 12.375a2.625 2.625 0 110-5.25 2.625 2.625 0 010 5.25z"
    />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M10.5 17.625a2.625 2.625 0 110-5.25 2.625 2.625 0 010 5.25z"
    />
  </svg>
);